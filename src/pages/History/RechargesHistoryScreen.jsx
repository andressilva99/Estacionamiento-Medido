...
const RechargesHistoryScreen = ({ navigation }) => {
  ...
  const SearchHistory = async () => {
    ...
    const monthInitial = String(dateInitial.getMonth() + 1).padStart(2, "0");
        ...
        {consult ? (
          <>
            <VStack space="sm">
              <HStack minW="85%">
                <Stack
                  style={[styles.tableContainer, styles.tableContainerLeft]}
                >
                  <Text style={styles.textTableHeader}>Fecha</Text>
                </Stack>
                <Stack
                  style={[styles.tableContainer, styles.tableContainerCenter]}
                >
                  <Text style={styles.textTableHeader}>Importe</Text>
                </Stack>
                <Stack
                  style={[styles.tableContainer, styles.tableContainerRight]}
                >
                  <Text style={styles.textTableHeader}>Saldo</Text>
                </Stack>
              </HStack>
              <ScrollView
                ...
                <VStack space="sm">
                  {listRecharges.map((recharge, index) => (
                    <HStack minW="85%" key={index}>
                      ...
                      >
                        <Text
                          style={[styles.textTableItems, { paddingRight: 8 }]}
                        >
                          {"$ " + recharge.cost}
                        </Text>
                      </Stack>
              ...
              >
                <Text style={styles.textButton}>Volver a consultar</Text>
              </Button>
            </VStack>
          </>
        ) : (
          <>
            ...
            {loaging ? (
              <Button
                ...
                style={styles.button}
                isLoadingText={
                  <Text style={styles.textButton}>Consultando</Text>
                }
